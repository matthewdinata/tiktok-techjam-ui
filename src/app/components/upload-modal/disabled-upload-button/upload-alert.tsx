...
export default function UploadAlert({
	...
	return (
		<AlertDialog open={open} onOpenChange={onOpenChange}>
			<AlertDialogContent className="max-w-[80%] w-96 bg-neutral-900 border-neutral-700 text-white rounded-md z-50">
				<AlertDialogHeader>
					<AlertDialogTitle>Oops!</AlertDialogTitle>
					<AlertDialogDescription className="text-white">
						Your still have a highlight video processing. Please
